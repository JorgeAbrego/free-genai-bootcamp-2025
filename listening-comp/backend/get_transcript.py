...
if __name__ == "__main__":
    video_origin_url = "https://www.youtube.com/watch?v=JNaUeTxSgqQ"  # Extract from URL: XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    transcript = main(video_origin_url, print_transcript=True)